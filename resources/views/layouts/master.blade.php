...
<head>
    ...
    <link href="/stylesheets/plugins/bootstrap_daterangepicker/bootstrap-daterangepicker.css" media="all" rel="stylesheet" type="text/css" />
    <link href="/stylesheets/plugins/fullcalendar/fullcalendar.css" media="all" rel="stylesheet" type="text/css" />
    <link href="/stylesheets/plugins/common/bootstrap-wysihtml5.css" media="all" rel="stylesheet" type="text/css" />
    ...
    <nav class='navbar navbar-default'>
        ...
        <ul class='nav'>
            <li class='dropdown light only-icon'>
                ...
                <ul class='dropdown-menu color-settings'>
                    <li class='color-settings-body-color'>
                        ...
                        <a data-change-to='/stylesheets/light-theme.css' href='#'>
                            Light
                            <small>(default)</small>
                        </a>
                        <a data-change-to='/stylesheets/dark-theme.css' href='#'>
                            Dark
                        </a>
                        <a data-change-to='/stylesheets/dark-blue-theme.css' href='#'>
                            Dark blue
                        </a>
                    </li>
                    <li class='divider'></li>
                    ...
                    <li>
                        <a href='#'>
                            <div class='widget-body'>
                                ...
                                <div class='pull-left text'>
                                    America Leannon commented NoThanks with veeery long text.
            ...
            <li class='dropdown dark user-menu'>
                <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                    <img width="23" height="23" alt="Mila Kunis" src="/images/avatar.jpg" />
...
<script src="/javascripts/plugins/flot/excanvas.js" type="text/javascript"></script>
<script src="/javascripts/plugins/flot/flot.min.js" type="text/javascript"></script>
<script src="/javascripts/plugins/flot/flot.resize.js" type="text/javascript"></script>
<script>
...
<script src="/javascripts/plugins/bootstrap_daterangepicker/bootstrap-daterangepicker.js" type="text/javascript"></script>
<script src="/javascripts/plugins/common/moment.min.js" type="text/javascript"></script>
<script src="/javascripts/plugins/bootbox/bootbox.min.js" type="text/javascript"></script>
<script src="/javascripts/plugins/slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<script src="/javascripts/plugins/timeago/jquery.timeago.js" type="text/javascript"></script>
<script src="/javascripts/plugins/common/wysihtml5.min.js" type="text/javascript"></script>
<script src="/javascripts/plugins/common/bootstrap-wysihtml5.js" type="text/javascript"></script>
<script src="/javascripts/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
<script src="/javascripts/plugins/bootbox/bootbox.min.js" type="text/javascript"></script>
<script>
    (function() {
